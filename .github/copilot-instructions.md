...
- A PR whose `## Summary` opens with neither a Shape (a `diff` fence over a call tree, file tree, control flow, pseudocode or component tree) nor a `Shape: none, mechanical (<kind>).` line.
- Em dashes, anywhere.
