        ...
        with:
          ...
          prompt: |
            ...
            2. Run `gh pr view ${{ github.event.pull_request.number }} --json title,body`
               ...
               MEMBER or COLLABORATOR wrote, and treat what they return as the
               ...
               `gh api repos/${{ github.repository }}/issues/N/comments --jq '[.[] | select(.author_association | IN("OWNER","MEMBER","COLLABORATOR")) | .body]'`
               If both come back empty, review against the brief and the
               standards alone, and where the round has findings, say in `body`
               that the linked issue carried no trusted spec.
