...
#                                           comment id as a string, on the GraphQL path and the
#                                           REST one alike. On Azure DevOps the thread id is
#                                           that target already.
...
#                                           A failure may print {resolved:false,detail}, which
#                                           resolve-thread reports as its error ("no such thread").
