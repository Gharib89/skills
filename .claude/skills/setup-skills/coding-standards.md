...
<!-- The PR body entry below is ship's, true in every repo that installs it; leave it and add the repo's own conventions under it: commit subject format, test naming, layering rules. `None recorded yet.` is a legal line for the repo's own. -->
