...
- The `## Verification` section, when the template lacks it, placed before `## Review` so the attribution footer still sits after every section a later phase rewrites.
