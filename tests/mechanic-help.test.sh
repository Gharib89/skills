...
help_case ci-wait        'usage: ci-wait <pr> [--timeout <s>, at least the 120s no-checks grace] [--interval <s>]'
...
help_case poll-pr        'usage: poll-pr <pr> [--brief] [--await-review <login>] [--since <iso>] [--await-run <workflow-file>, whose run holds the window open past --timeout, to 1800s] [--full <id>[,<id>]] [--timeout <s>] [--interval <s>]'
...
help_case run-file      'usage: run-file init <issue|slug> --scratchpad <dir> [--rebuild] [--state <n>=<spec>] [--tripwires <t>] [--verifications <v>] [--reviewers <r>] [--legs <l>] | open <n> --file <path> | close <n> --file <path> | skip <n> <reason> --file <path> | timing --file <path>'
