...
help_case poll-pr        'usage: poll-pr <pr> [--brief [--full <id>[,<id>]]] [--await-review <login>] [--since <iso>] [--await-run <workflow-file>, whose run holds the window open past --timeout, to 1800s] [--timeout <s>] [--interval <s>]'
