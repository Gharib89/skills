...
help_case poll-pr        'usage: poll-pr <pr> [--brief] [--await-review <login>] [--since <iso>] [--await-run <workflow-file>, waited out to its conclusion within 1800s] [--full <id>[,<id>]] [--timeout <s>] [--interval <s>]'
